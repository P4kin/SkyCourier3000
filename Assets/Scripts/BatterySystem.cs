...
public class BatterySystem : MonoBehaviour
{
    ...
    public float maxBattery = 1000f;           // УВЕЛИЧЕНО
    public float baseDrainRate = 1f;          // УМЕНЬШЕНО (базовый расход)
    public float movementDrainRate = 0.5f;    // УМЕНЬШЕНО (расход при движении)
    public float liftDrainRate = 0.8f;        // УМЕНЬШЕНО (расход при подъеме)
    public float lowBatteryThreshold = 100f;  // Соответственно увеличено
